...
const isNull = (value: unknown) =>
  getTypeStr(objectToString.call(value)) === 'null';
const isFunction = (value: unknown) =>
  getTypeStr(objectToString.call(value)) === 'function';
const isDate = (value: unknown) =>
  getTypeStr(objectToString.call(value)) === 'date';
const isMap = (value: unknown) =>
  getTypeStr(objectToString.call(value)) === 'map';
const isSet = (value: unknown) =>
  getTypeStr(objectToString.call(value)) === 'set';
const isRegExp = (value: unknown) =>
  getTypeStr(objectToString.call(value)) === 'regexp';
const isWechatBrowser = () =>
  (navigator?.userAgent.toLowerCase() as string).includes('micromessenger');
