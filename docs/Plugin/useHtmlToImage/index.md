...
使用 [`html-to-image`](https://github.com/bubkoo/html-to-image) 库下载指定DOM元素内容为图片

## Basic Usage

```ts
import { useHtmlToImage } from '@flypeng/tool';
 ...
 */
declare function useHtmlToImage(
